...
@Component({
  selector: 'dbs-input-moeda',
  templateUrl: './dbs-input-moeda.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => DbsInputMoedaComponent),
      multi: true
    }
  ]
})
export class DbsInputMoedaComponent implements ControlValueAccessor, OnInit {
